...
me_diffprep <- function(data = data,
  ...
  # By default, the contrast is group1 - group2

  library(limma)
  library(metaMA)
  library(statmod)

  # Ensure sample ID order is consistent
  ...
  # Calculate group mean expression
  ...
  # Combine group means with differential results
